...
const MSPropertyValueConfig_1 = require("../domain/helpers/MSPropertyValueConfig");
class JsonConfig {
    /**
     *
     * @returns {Promise<MSPropertyValueConfig>} Configurações do micro serviço de configurações
     */
    mSPropertyValueConfig() {
        return __awaiter(this, void 0, void 0, function* () {
            const resultConfig = new MSPropertyValueConfig_1.MSPropertyValueConfig();
